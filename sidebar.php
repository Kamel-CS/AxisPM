      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item dropdown">
            <a href="index.php" class="nav-link nav-home hover-effect">
        ...
        <?php endif; ?>
          <li class="nav-item">
            <a href="./index.php?page=ai_management" class="nav-link nav-ai_management">
          ...
          <li class="nav-item">
            <a href="index.php?page=notifications" class="nav-link nav-notifications">
